...
class Baseoperation:
    ...
    def input_check(self, systolic, input_operand):
        if input_operand.shape[0] != systolic.row:
            return_value = True
        else:
            return_value = False
    ...
    def filter_check(self, systolic, filter_operand):
        if filter_operand.shape != systolic.col:
            return_value = True
        else:
            return_value = False
