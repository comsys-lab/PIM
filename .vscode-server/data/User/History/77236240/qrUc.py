    ...
    def df_os(self, scaleup, operand, scaleup_info):
        ...
        for row in range(info[0]):
            ...
            for col in range(info[1]):
                ...
                output_tile = self.base_operation.skew_output_matrix(self.base_operation.filter_padding(systolic, output_tile))
        ...
        print(input_final.shape, filter_final.shape, ouptut_final.shape)
