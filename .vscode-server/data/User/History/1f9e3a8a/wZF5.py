...
class ScaleUp:
    ...
    def scaleup_info(self, scaleup, operand):
        ...
        scaleupinfo = [[num_row,num_col],[[[full_row, full_col, full_row_count, full_col_count],[full_row, rest_col, full_row_count, rest_col_count]],\
                                        [[rest_row, full_col, rest_row_count, full_col_count],[rest_row, rest_col, rest_row_count, rest_col_count]]]]
